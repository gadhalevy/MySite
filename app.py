...
def fill_container(pic, wrt1, wrt2, wrt3, mrkdn, img, txt1, txt2, txt3, txt4, color, width=300, spaces=0):
    ...
    wrt2.write(f'{txt2}')
    wrt3.write(f'{txt3}')
    mrkdn.markdown(f'<div style="direction:rtl;font-size:1em;color:gray;background-color:{color};">{txt4}</div>',
                   unsafe_allow_html=True)
...
col2.header(':israel: :rainbow[Puzzle Mind] :israel:', divider=True)
...
c1_pic, c1_wrt1, c1_wrt2, c1_wrt3, c1_mrkdn1 = setup_container(col1)
if res == 'תשבץ הגיון':
    img = 'assets/images/higayon.png'
    txt1 = 'תשבץ הגיון'
    txt2 = ''
    txt3 = ''
    txt4 = 'תשבץ הגיון מבוסס הקשר לארוע מסוים או לקבוצה מסוימת מוקרן על מסך גדול המנצח הינו זה הפותר את מירב ההגדרות.'
    fill_container(c1_pic, c1_wrt1, c1_wrt2, c1_wrt3, c1_mrkdn1, img, txt1, txt2, txt3, txt4, 'yellow', 600)
if res == 'זיהוי דמות':
    img = 'assets/images/mi.png'
    txt1 = 'מי הדמות'
    txt2 = ''
    txt3 = ''
    ...
    fill_container(c1_pic, c1_wrt1, c1_wrt2, c1_wrt3, c1_mrkdn1, img, txt1, txt2, txt3, txt4, 'cyan', 600)
if res == 'זיהוי מקום':
    ...
    fill_container(c1_pic, c1_wrt1, c1_wrt2, c1_wrt3, c1_mrkdn1, img, txt1, txt2, txt3, txt4, 'greenyellow', 600)
